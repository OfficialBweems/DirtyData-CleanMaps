...
data_sum = full_data %>% # data to manipulate
  ...
  tally() # count them
# Note: adding column names to the group by argument will increase your number of rows
...
# Note: Date is gone since you have aggregated the number of fish over multiple days
